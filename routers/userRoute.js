...
router.get("/referrals/:referralCode", EmployeeController.ReferralCodeData);
...
//Add Shop Products
router.post("/shopproduct", upload.single("image"), ShopController.ShopProduct);
router.get("/shopproduct", ShopController.GetAllShopProduct);
router.get("/shopproducts/:productId", ShopController.getShopProductById);
router.delete("/shopproduct/:productId", ShopController.DeleteShopProduct);
router.put(
  "/shopproduct/:productId",
  upload.single("image"),
  ShopController.EditShopProduct
);
...
router.post(
  ...
  userController.employeeDocument
);
...
router.post(
  ...
  BusniessCategoryController.BusniessCategory
);
router.get(
  "/business-categories",
  BusniessCategoryController.getAllBusinessCategories
);
router.delete(
  "/businessCategory/:id",
  BusniessCategoryController.deleteBusinessCategory
);

// payment routes
router.post(
  "/payment-details",
  upload.single("paymentscreensort"),
  PaymentMethodController.PaymentMethod
);
router.get(
  "/getAllPaymentDetails",
  upload.single("paymentscreensort"),
  PaymentMethodController.getAllPaymentDetails
);
router.get(
  "/payments/:userId",
  PaymentMethodController.getPaymentDetailsByUserId
);
